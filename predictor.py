...
pred_bboxes, pred_labels, pred_ages, pred_scores = ssd_decoder_model.predict(test_data, steps=step_size, verbose=1)

if evaluate:
    eval_utils.evaluate_predictions(test_data, pred_bboxes, pred_labels, pred_ages, pred_scores, labels, ages, batch_size)
else:
    drawing_utils.draw_predictions(test_data, pred_bboxes, pred_labels, pred_ages, pred_scores, labels, ages, batch_size)
